...
class _OrderScreenState extends State<OrderScreen> {
  ...
  List<DropdownMenuEntry<BreadType>> _buildBreadTypeEntries() {
    ...
    for (final bread in BreadType.values) {
      entries
          .add(DropdownMenuEntry<BreadType>(value: bread, label: bread.name));
    }
    return entries;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final routeLabels = {'/': 'Home', '/about': 'About', '/login': 'Account'};
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            // Navigation to account is provided by the app header/drawer.
          ],
        ),
      ),
    );
    ...
    return Scaffold(
      appBar: Header.buildAppBar(context, title: 'Sandwich Counter'),
      drawer:
